				...
				<c:when test="${totalPages != null }">
					<div>
			            <ul class="pager" style="text-align: center;">
			              <li style="margin-right: 10px;"><a href="<%=basePath%>/archive_list?page=${(page==1)? page : page-1}">Previous</a></li>
			              <li style="margin-left: 10px;"><a href="<%=basePath%>/archive_list?page=${page == totalPages ? page : page+1}">Next</a></li>
			            </ul>
		          	</div>
				</c:when>
			</c:choose>
